...
from mmdet.core import (anchor_inside_flags, build_anchor_generator,
                        ...
                        images_to_levels, multi_apply, multiclass_nms, unmap, reduce_mean)
...
class AnchorHead(BaseDenseHead, BBoxTestMixin):
    ...
    def loss_single(self, cls_score, bbox_pred, anchors, labels, label_weights,
                    bbox_targets, bbox_weights, idx, num_total_samples):
        ...
        if lvl_valid_labels.device.index == 0:
            with open('/home/wubinghong/code/baidu/personal-code/mmdet/retinanet_sum.log', 'a') as f:
